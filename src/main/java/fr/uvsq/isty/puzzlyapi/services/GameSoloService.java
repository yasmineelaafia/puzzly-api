...
import fr.uvsq.isty.puzzlyapi.repositories.GameSoloRepository;

@Service
public class GameSoloService {
    @Autowired
    private GameSoloRepository gameSoloRepository;

    public void saveGame(GameSolo game) {
        gameSoloRepository.save(game);
    }
}
